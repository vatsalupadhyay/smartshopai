...
const features = [
  {
    ...
    description: "Monitor product prices across multiple stores and get notified when prices drop. AI predicts the best time to buy.",
  ...
  },
  {
    ...
    description: "Our AI analyzes millions of reviews to identify fake ones, giving you authentic insights from real customers.",
  ...
  },
  {
    ...
    description: "Chat with our AI to compare products, get recommendations, and make informed purchasing decisions.",
